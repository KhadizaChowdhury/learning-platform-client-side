            ...
            <Row>
                <Col lg={10}>
                    <div>
                        ...
                        <div className='my-5'>
                            <h3 className='mb-5 text-center'>We are offering {courses.length} Courses for you!</h3>
                        ...
                        <Container>
                            <div className='bg-dark mt-5 p-5 text-center text-white row justify-content-center align-items-center'>
                                <h2>About us</h2>
                                <p>Hello everyone!</p>
